...
function App() {
  ...
  let cmntdata=[], photodata=[], tododata=[], postdata=[];
    ...
    <div className="App">
      <Row justify="center">
            <Col style={{border: '3px solid #eee' }} span={9}>
              ...
              <Row>
                <Col span={12}>
                <Button type="primary" onClick={button1}>Button 1</Button>
                </Col>
                <Col span={12}>
                <Button type="primary"  onClick={button2}>Button 2</Button>
                </Col>
              </Row>
              ...
              <Row>
                <Col span={12}>
                <Button type="primary"  onClick={button3}>Button 3</Button>
                </Col>
                <Col span={12}>
                <Button type="primary"  onClick={button4}>Button 4</Button>
                </Col>
              </Row>
